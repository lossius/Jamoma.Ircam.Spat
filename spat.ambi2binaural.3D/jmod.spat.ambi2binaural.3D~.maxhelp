{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 200.0, 60.0, 1222.0, 788.0 ],
		"bglocked" : 0,
		"defrect" : [ 200.0, 60.0, 1222.0, 788.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 730.0, 172.0, 29.0 ],
					"text" : "/source.1/position 0.26 0.67 -0.71"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "3D binaural decoding of 1st order (B-format) ambisonic signal."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "spat.jmod.ambi2binaural.3D~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 675.0, 154.0, 31.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "/ambi2binaural.3D~" ],
					"id" : "obj-31",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "jmod.spat.ambi2binaural.3D~.maxpat",
					"numinlets" : 2,
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 34.5, 718.0, 261.0, 718.0, 261.0, 263.0, 299.5, 263.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 34.5, 727.0, 192.5, 727.0 ],
					"source" : [ "obj-12", 0 ]
				}
